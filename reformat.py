...
REFORMAT_SYSTEM = (
    ...
    "- Do NOT deduplicate. If any text is REPEATED in the input (e.g. an 'about the "
    "company' paragraph that appears twice, or a duplicated sentence/section), reproduce "
    "EVERY copy verbatim in its original position. Repetition in the input is not an "
    "error to fix — feeds sometimes include a boilerplate block more than once.\n"
